...
[📖 查看文档](#-文档目录) • [🚀 快速开始](#-快速开始) • [💡 功能特性](#-功能特性) • [📞 技术支持](#-技术支持)
...
### 🖥️ 主管理界面
![主界面](./frontend/screenshots/dashboard-overview.png)

### 📱 移动端界面
![移动端](./frontend/screenshots/mobile-responsive.png)

### 📈 交易监控界面
![交易界面](./frontend/screenshots/trading-interface.png)
...
| 文档 | 描述 | 链接 |
|------|------|------|
| 📋 安装指南 | 详细的系统安装和配置步骤 | [查看文档](./docs/INSTALLATION.md) |
| 📖 用户手册 | 完整的用户操作指南 | [查看文档](./docs/USER_GUIDE.md) |
| 🔌 API文档 | 完整的API接口文档 | [查看文档](./docs/API_REFERENCE.md) |
| 🏗️ 系统架构 | 详细的技术架构说明 | [查看文档](./docs/ARCHITECTURE.md) |
| 📱 前端文档 | 前端技术和界面说明 | [查看文档](./frontend/README.md) |
| 📝 更新日志 | 版本更新和功能变更记录 | [查看文档](./docs/CHANGELOG.md) |
